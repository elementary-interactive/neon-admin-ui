...
class AdminPanelProvider extends PanelProvider
{
	public function panel(Panel $panel): Panel
	{
		...
		$admin
			->navigationGroups(
				array_merge(config('neon-admin.groups', []), [
	...
	private function scanNeonResources(): array
	{
		...
		if (class_exists(\Neon\Redirect\Models\Redirect::class)) {
			$resources[] = \Neon\Admin\Resources\RedirectResource::class;
		}
